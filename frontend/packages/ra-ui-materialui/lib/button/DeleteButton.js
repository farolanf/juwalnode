...
var DeleteButton = /** @class */ (function (_super) {
    ...
    DeleteButton.prototype.render = function () {
        ...
        return (react_1.default.createElement(Button_1.default, __assign({ onClick: this.handleDelete, label: label, className: classnames_1.default('ra-delete-button', classes.deleteButton, className), key: "button" }, sanitizeRestProps(rest)), icon));
    };
    return DeleteButton;
}(react_1.Component));
DeleteButton.propTypes = {
    ...
    dispatchCrudDelete: prop_types_1.default.func.isRequired,
...
exports.default = compose_1.default(react_redux_1.connect(null, { startUndoable: ra_core_1.startUndoable, dispatchCrudDelete: ra_core_1.crudDelete }), ra_core_1.translate, styles_1.withStyles(styles))(DeleteButton);
