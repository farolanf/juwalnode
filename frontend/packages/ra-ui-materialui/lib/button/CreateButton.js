...
var CreateButton = function (_a) {
    ...
    return (react_1.default.createElement(Responsive_1.default, { small: react_1.default.createElement(Button_1.default, __assign({ component: react_router_dom_1.Link, variant: "fab", color: "primary", className: classnames_1.default(classes.floating, className), to: basePath + "/create", "aria-label": label && translate(label) }, rest), icon), medium: react_1.default.createElement(Button_2.default, __assign({ component: react_router_dom_1.Link, to: basePath + "/create", className: className, label: label && translate(label) }, rest), icon) }));
};
