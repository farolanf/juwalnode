...
var CreateButton = function (_a) {
    ...
    return (React.createElement(Responsive, { small: React.createElement(MuiButton, __assign({ component: Link, variant: "fab", color: "primary", className: classnames(classes.floating, className), to: basePath + "/create", "aria-label": label && translate(label) }, rest), icon), medium: React.createElement(Button, __assign({ component: Link, to: basePath + "/create", className: className, label: label && translate(label) }, rest), icon) }));
};
