 ...
 *     );
 */
export var List = function (props) { return (React.createElement(ListController, __assign({}, props), function (controllerProps) { return React.createElement(ListView, __assign({}, props, controllerProps)); })); };
List.propTypes = {
